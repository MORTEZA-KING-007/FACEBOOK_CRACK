...
echo -e '\033[37m[ + ] All packages in this project is safe no trojan..........'
echo -e '\033[37m[ + ] Enter or Press (y/Y) to continue.........'

# TOOL NEED THIS PERMMISION TO MAKE MORTEZA-CP/OK.txt FILE IN /SDCARD
termux-setup-storage

espeak -s 200 "Installing requirements"
echo -e '\033[37m[ + ] Installing libraries and other packages.......'

apt install python -y
pip install requests bs4 colorama pyfiglet psutil

espeak -s 200 "Welcome to facebook crack tool"
espeak -s 200 "subscribe my telegram channel friends for more VIP tool"

echo -e '\033[37m[ + ] Tool is ready to use enjoy.......'
